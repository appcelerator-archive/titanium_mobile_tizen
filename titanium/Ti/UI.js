define(
	...
	var global = window,
		...
		body = doc.body,
		on = require.on,
		modules = "2DMatrix,ActivityIndicator,AlertDialog,Animation,Button,EmailDialog,ImageView,Label,OptionDialog,Picker,PickerColumn,PickerRow,ProgressBar,ScrollableView,ScrollView,SearchBar,Slider,Switch,Tab,TabGroup,TableView,TableViewRow,TableViewSection,TextArea,TextField,View,WebView,Window,Notification",
		creators = {},
		setStyle = style.set,
	...
	return lang.setObject("Ti.UI", Evented, creators, {
		...
		convertUnits: function(convertFromValue, convertToUnits) {
			var intermediary = +(dom.computeSize(convertFromValue, 0, false)) || 0; // even if result is NaN - convert it to 0;
		...
		constants: {
			...
			KEYBOARD_URL: 8,
			KEYBOARD_NUMBERS_PUNCTUATION: 9,
