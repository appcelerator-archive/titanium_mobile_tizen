define(["Ti/_/Evented", "Ti/_/lang"], function(Evented, lang) {
	...
	function _mapImageFromTizen(uri){
		if(!uri) return null;
	...
	return lang.setObject("Ti.Contacts", Evented, {
		...
		_mapContactFromTizen: function(tizenContact) {
			...
			person.organization = (organization && organization.name) ? organization.name : '';
			person.department = (organization && organization.department) ? organization.department : '';
			person.jobTitle = (organization && organization.title) ? organization.title : '';
