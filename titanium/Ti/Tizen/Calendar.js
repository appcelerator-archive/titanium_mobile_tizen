define(['Ti/_/lang', 'Ti/_/Evented', 'Ti/Tizen/Calendar/Calendar', 'Ti/Tizen/Calendar/CalendarTask', 'Ti/Tizen/Calendar/CalendarEvent', 'Ti/Tizen/Calendar/CalendarAttendee',
	...
	function onCalendarItemArraySuccessCallback(object, onsuccess) { 
		onsuccess.call(null, new CalendarItem(object));
	};

	function onCalendarArraySuccessCallback(object, onsuccess) { 
		onsuccess.call(null, new Calendar(object));
	};
});