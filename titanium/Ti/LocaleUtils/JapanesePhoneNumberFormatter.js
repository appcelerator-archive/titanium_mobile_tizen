...
var FORMAT_MAP = [-100, 10, 220, -15, 410, 530, 1200, 670, 780, 1060,
    ...
    function formatJapaneseNumberInternal(s) {
        s = s + "";
...
/// todo: do we need to remove spaces?
    ...
    return {
        formatJapaneseNumber: function (s) {
            return formatJapaneseNumberInternal(s);
        }
    };
});