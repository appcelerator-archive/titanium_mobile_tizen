...
/// format dateFormat (like: dd-MM-yy, HH:mm:ss e.t.c. )
/// cal - localized calendar object from Titanium localeStoreage
    ...
    return {
        formatDecimal: function (decimalValue, pattern, localeNumberInfo) {
            return formatDecimalInternal(decimalValue, pattern, localeNumberInfo);
        },
        generatePatternFromGroupSizes: function (groupSizes, maxDigitsInPattern) {
            return generatePatternFromDotNetNotation(groupSizes, maxDigitsInPattern);
        },
        formatCurrency: function (value, currencyFormatInfo) {
            return formatCurrencyInternal(value, currencyFormatInfo);
        },
        formatDate: function ( value, format, cal) {
            return formatDateInternal( value, format, cal);
        }
    };
});