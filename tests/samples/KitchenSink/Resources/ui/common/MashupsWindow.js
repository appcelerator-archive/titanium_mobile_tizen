function MashupsWindow(title) {
	...
	if(!isTizen) {
		data.push({title:'Foursquare', hasChild:!isMobileWeb, test:'ui/common/mashups/foursquare', title_image:'/images/light-poweredby-foursquare.png', touchEnabled:!isMobileWeb, color:isMobileWeb?"#aaa":"#000"});	
		data.push({title:'Facebook', hasChild:true, test:'ui/common/mashups/facebook'});	
	} 
