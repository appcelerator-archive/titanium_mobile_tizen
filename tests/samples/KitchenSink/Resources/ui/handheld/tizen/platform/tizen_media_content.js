function tizen_media_content(args) {
    var self = Titanium.UI.createWindow(),
        data = [
            {title: 'Files', hasChild: true, test: 'ui/handheld/tizen/platform/tizen_media_content_files'},
            {title: 'Folders', hasChild: true, test: 'ui/handheld/tizen/platform/tizen_media_content_directories'}
        ],
