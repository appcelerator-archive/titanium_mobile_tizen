...
module.exports = new function() {
	...
	var FOOTER_TITLE = "Footer Title";
	var HEADER_TITLE = 'Header 1';
	...
	this.setProp = function(testRun) {
		...
		var newHeaderTitle = "New Header Title";
	...
	this.rows = function(testRun) {
			...
			setTimeout(function(){
				...
				//valueOf(testRun,tv.sections[0].getRows()).shouldNotBeUndefined();
	...
	this.addRemove = function(testRun) {
		...
		for(var i=0;i< section1.getRows().length; i++ ){
		...
		for(var i=0;i< section2.getRows().length; i++ ){
		...
		//valueOf(testRun,section1.getRowCount()===0).shouldBeTrue();	
