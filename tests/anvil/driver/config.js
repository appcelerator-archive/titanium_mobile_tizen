...
module.exports = new function() {
	...
	Examples:
	var baseDir = path.resolve(path.sep, "Users", "SomeUser", "dev");
	...
	*/
	this.tiSdkDirs = path.resolve(path.sep,"home","iostash",".titanium","mobilesdk","linux");
	...
	*/
	...
	// max number of connection attempts (driver to harness) for socket based test runs
	this.maxSocketConnectAttempts = 40;
	...
	*/
	...
	this.androidSdkDir = path.resolve(path.sep,"c:", "AndroidSDK");
	...
	*/
	...
	this.driverDescription = "this is an example driver instance. Test";
