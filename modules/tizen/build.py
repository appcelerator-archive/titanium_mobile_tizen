...
version = '3.2.0.v20130407111754'
sdk_path = r'/home/aod/.titanium/mobilesdk/linux/3.2.0.v20130407111754'
...
class Compiler(object):
	...
	def package(self):
		...
		install_path = 'modules/tizen/%s/%s' % (moduleid, version)
		
		zip_file = os.path.join(self.module_path, '%s-tizen-%s.zip' % (moduleid,version))
