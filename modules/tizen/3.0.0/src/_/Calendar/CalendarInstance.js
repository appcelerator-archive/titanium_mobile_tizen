define(['Ti/_/declare', 'Ti/_/Evented', '_/Calendar/CalendarEvent', '_/Calendar/CalendarItem', '_/WebAPIError'], function(declare, Evented, CalendarEvent, CalendarItem, WebAPIError) {
