 ...
 *
 * This is a slightly modified declare.js file from Titanium Mobile Web. We cannot use the original
 * due to the setObject call in the declare() function. See comment in declare() for details.
 */
...
define(["Ti/_", "Ti/_/lang"], function(_, lang) {
	...
	function declare(className, superclass, definition) {
		...
		if (className) {
            ...
            // setObject is not needed, because in the Tizen module we do not want to introduce
            // names in the global scope. However, we need the functionality from "declare.js"
            // for other things.
