...
public class InputProccesor {
	...
	public static final String CERT_FILE_PATH_DEFAULT = "com/appcelerator/tizen/signapp/samsung.devmode.sdk.cert.p12";
	...
	public void showErrorOnConsole() throws WrongInputException {
		System.err
				.println("You enter wrong parameters. "
						+ " Use:\n"
	...
	public void proccesInputData(String[] consoleArg) throws WrongInputException {
	...
	private void projectPathResolver() {
		...
		if (projectPath != null && !projectPath.endsWith("/") && !projectPath.endsWith("\\")) {
